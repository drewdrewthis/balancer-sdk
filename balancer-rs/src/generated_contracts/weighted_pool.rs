...
pub mod weighted_pool {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(WeightedPool))
        .field(&self.address())
        .finish()
    }
  }
  ...
  impl Signatures {
    ...
    #[doc = "Returns signature for method `decreaseApproval(address,uint256):(bool)`."]
    #[allow(clippy::type_complexity)]
    pub fn decrease_approval(
      ...
      bool,
    > {
      self::ethcontract::contract::Signature::new([102, 24, 132, 99])
    }
    ...
    #[doc = "Returns signature for method `getInvariant():(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_invariant(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::U256> {
      self::ethcontract::contract::Signature::new([192, 255, 26, 21])
    }
    #[doc = "Returns signature for method `getLastInvariant():(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_last_invariant(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::U256> {
      self::ethcontract::contract::Signature::new([155, 2, 205, 222])
    }
    #[doc = "Returns signature for method `getNormalizedWeights():(uint256[])`."]
    #[allow(clippy::type_complexity)]
    pub fn get_normalized_weights(
      &self,
    ) -> self::ethcontract::contract::Signature<(), Vec<self::ethcontract::U256>> {
      self::ethcontract::contract::Signature::new([248, 159, 39, 237])
    }
    #[doc = "Returns signature for method `getOwner():(address)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_owner(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::Address> {
      self::ethcontract::contract::Signature::new([137, 61, 32, 232])
    }
    ...
    #[doc = "Returns signature for method `getPoolId():(bytes32)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_pool_id(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::tokens::Bytes<[u8; 32]>>
    {
      self::ethcontract::contract::Signature::new([56, 255, 242, 208])
    }
    #[doc = "Returns signature for method `getRate():(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_rate(&self) -> self::ethcontract::contract::Signature<(), self::ethcontract::U256> {
      self::ethcontract::contract::Signature::new([103, 154, 239, 206])
    }
    #[doc = "Returns signature for method `getSwapFeePercentage():(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_swap_fee_percentage(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::U256> {
      self::ethcontract::contract::Signature::new([85, 198, 118, 40])
    }
    #[doc = "Returns signature for method `getVault():(address)`."]
    #[allow(clippy::type_complexity)]
    pub fn get_vault(
      &self,
    ) -> self::ethcontract::contract::Signature<(), self::ethcontract::Address> {
      self::ethcontract::contract::Signature::new([141, 146, 138, 248])
    }
    #[doc = "Returns signature for method `increaseApproval(address,uint256):(bool)`."]
    #[allow(clippy::type_complexity)]
    pub fn increase_approval(
      ...
      bool,
    > {
      self::ethcontract::contract::Signature::new([215, 61, 214, 35])
    }
    ...
    #[doc = "Returns signature for method `onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])`."]
    #[allow(clippy::type_complexity)]
    pub fn on_exit_pool(
      &self,
    ) -> self::ethcontract::contract::Signature<
      ...
      (Vec<self::ethcontract::U256>, Vec<self::ethcontract::U256>),
    > {
      self::ethcontract::contract::Signature::new([116, 243, 176, 9])
    }
    #[doc = "Returns signature for method `onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])`."]
    #[allow(clippy::type_complexity)]
    pub fn on_join_pool(
      &self,
    ) -> self::ethcontract::contract::Signature<
      ...
      (Vec<self::ethcontract::U256>, Vec<self::ethcontract::U256>),
    > {
      self::ethcontract::contract::Signature::new([213, 192, 150, 196])
    }
    #[doc = "Returns signature for method `onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256):(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn on_swap(
      &self,
    ) -> self::ethcontract::contract::Signature<
      ...
      self::ethcontract::U256,
    > {
      self::ethcontract::contract::Signature::new([157, 44, 17, 12])
    }
    ...
    #[doc = "Returns signature for method `queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])`."]
    #[allow(clippy::type_complexity)]
    pub fn query_exit(
      &self,
    ) -> self::ethcontract::contract::Signature<
      ...
      (self::ethcontract::U256, Vec<self::ethcontract::U256>),
    > {
      self::ethcontract::contract::Signature::new([96, 40, 191, 212])
    }
    #[doc = "Returns signature for method `queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])`."]
    #[allow(clippy::type_complexity)]
    pub fn query_join(
      &self,
    ) -> self::ethcontract::contract::Signature<
      ...
      (self::ethcontract::U256, Vec<self::ethcontract::U256>),
    > {
      self::ethcontract::contract::Signature::new([135, 236, 104, 23])
    }
    ...
    #[doc = "Returns signature for method `setSwapFeePercentage(uint256)`."]
    #[allow(clippy::type_complexity)]
    pub fn set_swap_fee_percentage(
      &self,
    ) -> self::ethcontract::contract::Signature<(self::ethcontract::U256,), ()> {
      self::ethcontract::contract::Signature::new([56, 233, 146, 46])
    }
  ...
  impl Methods {
    ...
    pub fn decrease_approval(
      ...
      self
        .instance
        .method([102, 24, 132, 99], (spender, amount))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn get_action_id(
    ...
    pub fn increase_approval(
      ...
      self
        .instance
        .method([215, 61, 214, 35], (spender, amount))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    ...
    pub fn on_exit_pool(
      ...
      balances: Vec<self::ethcontract::U256>,
      last_change_block: self::ethcontract::U256,
      protocol_swap_fee_percentage: self::ethcontract::U256,
    ...
    pub fn on_swap(
      ...
      balance_token_in: self::ethcontract::U256,
      balance_token_out: self::ethcontract::U256,
    ) -> self::ethcontract::dyns::DynViewMethodBuilder<self::ethcontract::U256> {
      self
        .instance
        .view_method(
    ...
    pub fn set_swap_fee_percentage(
      &self,
      swap_fee_percentage: self::ethcontract::U256,
    ) -> self::ethcontract::dyns::DynMethodBuilder<()> {
      self
        .instance
        .method([56, 233, 146, 46], (swap_fee_percentage,))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
  ...
  pub mod event_data {
    ...
    pub struct SwapFeePercentageChanged {
      pub swap_fee_percentage: self::ethcontract::U256,
    }
    impl SwapFeePercentageChanged {
      ...
      pub fn signature() -> self::ethcontract::H256 {
        self::ethcontract::H256([
          169, 186, 63, 254, 11, 108, 54, 107, 129, 35, 44, 170, 179, 134, 5, 160, 105, 154, 213,
          57, 141, 108, 206, 118, 249, 30, 232, 9, 227, 34, 218, 252,
        ])
      }
      #[doc = r" Retrieves the ABI signature for the event this data corresponds"]
      #[doc = r" to. For this event the value should always be:"]
      #[doc = r""]
      #[doc = "`SwapFeePercentageChanged(uint256)`"]
      pub fn abi_signature() -> &'static str {
        "SwapFeePercentageChanged(uint256)"
      }
    }
    impl self::ethcontract::tokens::Tokenize for SwapFeePercentageChanged {
      fn from_token(
        token: self::ethcontract::common::abi::Token,
      ) -> Result<Self, self::ethcontract::tokens::Error> {
        let (swap_fee_percentage,) = self::ethcontract::tokens::Tokenize::from_token(token)?;
        Ok(SwapFeePercentageChanged {
          swap_fee_percentage,
        })
      }
      fn into_token(self) -> self::ethcontract::common::abi::Token {
  ...
  impl Events<'_> {
    ...
    #[doc = r" Generated by `ethcontract`."]
    pub fn swap_fee_percentage_changed(
      &self,
    ) -> self::event_builders::SwapFeePercentageChangedBuilder {
      self::event_builders::SwapFeePercentageChangedBuilder(
        self
          .instance
          .event(self::ethcontract::H256([
  ...
  pub mod event_builders {
    ...
    #[doc = "A builder for creating a filtered stream of `SwapFeePercentageChanged` events."]
    pub struct SwapFeePercentageChangedBuilder(
      #[doc = r" The inner event builder."]
      pub  self::ethcontract::dyns::DynEventBuilder<self::event_data::SwapFeePercentageChanged>,
    );
    impl SwapFeePercentageChangedBuilder {
      #[doc = r" Sets the starting block from which to stream logs for."]
      #[doc = r""]
      #[doc = r" If left unset defaults to the latest block."]
      #[allow(clippy::wrong_self_convention)]
      ...
      pub async fn query(
        ...
        std::vec::Vec<self::ethcontract::Event<self::event_data::SwapFeePercentageChanged>>,
        self::ethcontract::errors::EventError,
      > {
        (self.0).query().await
      }
      ...
      pub fn stream(
        ...
        Item = std::result::Result<
          self::ethcontract::StreamEvent<self::event_data::SwapFeePercentageChanged>,
          self::ethcontract::errors::EventError,
        >,
      > {
        (self.0).stream()
  ...
  pub enum Event {
    ...
    SwapFeePercentageChanged(self::event_data::SwapFeePercentageChanged),
...
pub use self::weighted_pool::Contract as WeightedPool;
